...
//         circle.y + circle.translateY - circle.size, // distance from top edge
//         canvasSize.current.h - circle.y - circle.translateY - circle.size, // distance from bottom edge
//       ].sort((a, b) => a - b)[0]; // find the smallest distance

//       const alpha = remapValue(edge, 0, staticity, 0, circle.targetAlpha);
//       const newCircle = { ...circle, alpha };

//       // Handle the movement
//       const { dx, dy, magnetism } = circle;

//       const distX = circle.x - mouse.current.x;
//       const distY = circle.y - mouse.current.y;
//       const dist = Math.sqrt(distX * distX + distY * distY);

//       if (dist < 80) {
//         const x = distX / dist;
//         const y = distY / dist;
//         const force = (1 - (dist / 80)) * magnetism;

//         newCircle.dx += x * force;
//         newCircle.dy += y * force;
//       }

//       newCircle.x += newCircle.dx + vx;
//       newCircle.y += newCircle.dy + vy;
