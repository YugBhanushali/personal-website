...
const Music = () => {
  ...
  return (
    <>
      <Demo className="flex flex-col bg-zinc-900 p-6 rounded-[44px] gap-y-2  hover:scale-105 transition-all duration-500 ease-in-out">
        {/* <div
    ...
    > */}
        ...
        <div className="flex flex-row max-w-[300px] justify-between items-center mt-3 z-1">
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="text-[13px] text-gray-400">Hans Zimmer</div>
          </div>
        ...
        <div className="flex flex-col items-center justify-center gap-y-2">
          ...
          <div className="flex flex-row mt-[10px] items-center justify-center">
            <div
              className={`flex flex-row gap-2 text-[13px] justify-center items-center ${
                onMove.forBar ? `text-gray-200` : `text-gray-400`
            ...
            >
              ...
              <div>
                <Slider
                  ...
                  trackStyle={{
                    backgroundColor: onMove.forBar ? "#fff" : "#c4c4c4d1",
                    height: "5px",
                  }}
              ...
              <div>
                -
                {formatTime(totalSongTime - Number(currentSongTime.toFixed(0)))}
              </div>
            </div>
          ...
          <div className="flex flex-row gap-x-2 justify-center items-center">
            <div>
              <BsFillVolumeOffFill
                className={`${
                  onMove.forVolume ? `text-white` : `text-gray-500`
                } ease-in-out duration-200 text-3xl cursor-pointer`}
              />
            </div>
            <div>
              <Slider
                ...
                trackStyle={{
                  backgroundColor: onMove.forVolume ? "#fff" : "#c4c4c4d1",
                  height: "5px",
                }}
                railStyle={{ backgroundColor: "#c4c4c452", height: "5px" }}
                tooltip={{
